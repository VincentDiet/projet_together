  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.activities, (activity) => {
        _push(ssrRenderComponent(_sfc_main$4, { activity }, null, _parent));
      });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))}><div class="v-beat v-beat-odd" style="${ssrRenderStyle($data.spinnerStyle)}"></div><div class="v-beat v-beat-even" style="${ssrRenderStyle($data.spinnerStyle)}"></div><div class="v-beat v-beat-odd" style="${ssrRenderStyle($data.spinnerStyle)}"></div></div>`);
}
