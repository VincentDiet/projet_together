...
<template>
  <div>
    <div class="min-h-screen px-8 pt-10 text-slate-50 overflow-hidden pb-20" :class="class">
      <Head :title="title" />

      <!-- Page Heading -->
      <header class="">
        <nav class="fixed bottom-0 left-0 right-0 bg-gray-100 text-slate-900 z-50">
