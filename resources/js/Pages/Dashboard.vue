...
<template>
  <AppLayout title="Dashboard" class="bg-gradient-to-b from-together-cyan-light to-together-cyan-dark">
    <a :href="route('activities.add')" class="fixed bottom-20 right-10 text-gray-900 bg-together-green z-50 rounded-full p-2 shadow-xl">
